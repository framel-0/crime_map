...
class _$AppUserTearOff {
  ...
  _AppUser call({required UniqueId id, String? name, String? email}) {
    return _AppUser(
      id: id,
      name: name,
      email: email,
...
class _$_AppUser extends _AppUser {
  const _$_AppUser({required this.id, this.name, this.email}) : super._();
...
abstract class _AppUser extends AppUser {
  const factory _AppUser({required UniqueId id, String? name, String? email}) =
      _$_AppUser;
